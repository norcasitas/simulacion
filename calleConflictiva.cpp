#include "calleConflictiva.h"

void calleConflictiva::init(double t,...) {
...
data = fopen("grafico.dat", "w");
fprintf(data, "%lf %lf \n",t,(double)0);	

}
double calleConflictiva::ta(double t) {
return sigma;							
}
void calleConflictiva::dint(double t) {
...
void calleConflictiva::dext(Event x, double t) {
...
Event calleConflictiva::lambda(double t) {
